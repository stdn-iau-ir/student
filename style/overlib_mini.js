...
var CLOSESTYLE=72;
var CLOSEWEIGHT=73;
if(typeof ol_fgcolor=='undefined'){var ol_fgcolor="#E8EEF7";}
if(typeof ol_bgcolor=='undefined'){var ol_bgcolor="#4468BA";}
if(typeof ol_textcolor=='undefined'){var ol_textcolor="#F4A61F";}
...
if(typeof ol_close=='undefined'){var ol_close="خروج";}
...
//if (ns4 || ns6) document.captureEvents(Event.MOUSEDOWN);
//document.onmousedown=captureMouseXY;
...
//document.onmouseClick=mouseMove;
...
function ol_content_simple(text){
	if(ocss==CSSCLASS)txt="<TABLE WIDTH="+owidth+" BORDER=0 CELLPADDING="+oborder+" CELLSPACING=0 class=\""+obgclass+"\"><TR><TD><TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0 class=\""+ofgclass+"\"><TR><TD VALIGN=TOP><FONT class=\""+otextfontclass+"\">"+text+"</FONT></TD></TR></TABLE></TD></TR></TABLE>";
	if(ocss==CSSSTYLE)txt="<TABLE WIDTH="+owidth+" BORDER=0 CELLPADDING="+oborder+" CELLSPACING=0 style=\"background-color: "+obgcolor+";height: "+oheight+oheightunit+";\"><TR><TD><TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0 style=\"color: "+ofgcolor+";background-color: "+ofgcolor+";height: "+oheight+oheightunit+";\"><TR><TD VALIGN=TOP><FONT style=\"font-family: "+otextfont+";color: "+otextcolor+";font-size: "+otextsize+otextsizeunit+";text-decoration: "+otextdecoration+";font-weight: "+otextweight+";font-style:"+otextstyle+"\">"+text+"</FONT></TD></TR></TABLE></TD></TR></TABLE>";
	if(ocss==CSSOFF)txt="<TABLE WIDTH="+owidth+" BORDER=0 CELLPADDING="+oborder+" CELLSPACING=0 "+obgcolor+" "+oheight+"><TR><TD><TABLE WIDTH=100% BORDER= CELLPADDING=0 CELLSPACING=0 "+ofgcolor+" "+ofgbackground+" "+oheight+"><TR><TD VALIGN=TOP><FONT FACE=\""+otextfont+"\" COLOR=\""+otextcolor+"\" SIZE=\""+otextsize+"\">"+text+"</FONT></TD></TR></TABLE></TD></TR></TABLE>";
	set_background("");
	return txt;
}

//function
function _handleKey(keyStroke) {
	eventChooser = (ns4 || ns6) ? keyStroke.which : event.keyCode;
	if (eventChooser == "27") // if Esc pressed
		cClick();
}

function ol_content_caption(text, title, close){
	// Keyboard event registering
	document.onkeyup = _handleKey;
	closing="";
	...
	if(close !=""){
		if(ocss==CSSCLASS)closing="<TD ALIGN=LEFT><A HREF=\"/\" "+closeevent+"=\"return cClick();\" class=\""+oclosefontclass+"\">"
//                +close
		+ "<img border='0' src='Pages/images/cal/Cancel.gif'>"
                +"</A></TD>";
		if(ocss==CSSSTYLE)closing="<TD ALIGN=right><A title=\"براي خروج اينجا كليك كنيد و يا كليد Esc را فشار دهيد\" HREF=\"/\" "+closeevent+"=\"return cClick();\" style=\"color: "+oclosecolor+";font-family: "+oclosefont+";font-size: "+oclosesize+oclosesizeunit+";text-decoration: "+oclosedecoration+";font-weight: "+ocloseweight+";font-style:"+oclosestyle+";\">"
//                +close
		+ "<img border='1' style='border-color:#ffffff' src='Pages/images/cal/Cancel.gif'>"
                +"</A></TD>";
		if(ocss==CSSOFF)closing="<TD ALIGN=LEFT><A HREF=\"/\" "+closeevent+"=\"return cClick();\"><FONT COLOR=\""+oclosecolor+"\" FACE=\""+oclosefont+"\" SIZE=\""+oclosesize+"\">"
//                +close
		+ "<img border='0' src='Pages/images/cal/Cancel.gif'>"
                +"</FONT></A></TD>";
	}

        if(ocss==CSSCLASS)txt="<TABLE WIDTH="+owidth+" BORDER=0 CELLPADDING="+oborder+" CELLSPACING=0 class=\""+obgclass+"\"><TR><TD><TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0><TR><TD><FONT class=\""+ocaptionfontclass+"\">"+ocapicon+title+"</FONT></TD>"+closing+"</TR></TABLE><TABLE WIDTH=100% BORDER= CELLPADDING=0 CELLSPACING=0 class=\""+ofgclass+"\"><TR><TD VALIGN=TOP><FONT class=\""+otextfontclass+"\">"+text+"</FONT></TD></TR></TABLE></TD></TR></TABLE>";
        if(ocss==CSSSTYLE)txt="<TABLE onKeyUp=\"_handleKey()\" id=\"wholeDatePicker\" WIDTH="+owidth+" BORDER=0 CELLPADDING="+oborder+" CELLSPACING=0 style=\"background-color: "+obgcolor+";background-image: url("+obgbackground+");height: "+oheight+oheightunit+";\"><TR><TD><TABLE id=\"handleDatePicker\" WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0 style=\"cursor: move\"><TR>"+closing+"<TD align=right><FONT style=\"font-family: "+ocaptionfont+";color: "+ocapcolor+";font-size: "+ocaptionsize+ocaptionsizeunit+";font-weight: "+ocaptionweight+";font-style: "+ocaptionstyle+";\">"+ocapicon+title+"</FONT></TD>"+"</TR></TABLE><TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0 style=\"color: "+ofgcolor+";background-color: "+ofgcolor+";height: "+oheight+oheightunit+";\"><TR><TD VALIGN=TOP><FONT style=\"font-family: "+otextfont+";color: "+otextcolor+";font-size: "+otextsize+otextsizeunit+";text-decoration: "+otextdecoration+";font-weight: "+otextweight+";font-style:"+otextstyle+"\">"+text+"</FONT></TD></TR></TABLE></TD></TR></TABLE>";
        if(ocss==CSSOFF)txt="<TABLE WIDTH="+owidth+" BORDER=0 CELLPADDING="+oborder+" CELLSPACING=0 "+obgcolor+" "+obgbackground+" "+oheight+"><TR><TD><TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0><TR><TD><B><FONT COLOR=\""+ocapcolor+"\" FACE=\""+ocaptionfont+"\" SIZE=\""+ocaptionsize+"\">"+ocapicon+title+"</FONT></B></TD>"+closing+"</TR></TABLE><TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0 "+ofgcolor+" "+ofgbackground+" "+oheight+"><TR><TD VALIGN=TOP><FONT COLOR=\""+otextcolor+"\" FACE=\""+otextfont+"\" SIZE=\""+otextsize+"\">"+text+"</FONT></TD></TR></TABLE></TD></TR></TABLE>";
...
var fromX, fromY;
var fixedPositionX, fixedPositionY;
function placeLayer(){
	var placeX, placeY;
	if(ofixx > -1){
		placeX=ofixx;
...
//	repositionTo(over, fixedPositionX - fromX, fixedPositionY - fromY);
}
...
/*	if(ns4)obj.visibility="show";
	...
	else if(ns6)obj.style.display="inline";

	if (ie4 || ie5) hideCombos();
}
...
function hideCombos() {
	setCombosDisplay("hidden");
}

function showCombos() {
	setCombosDisplay("visible");
}

function setCombosDisplay(vis) {
	var pageBody = document.body;
	var nodeList = pageBody.getElementsByTagName("select");
	for(i = 0; i < nodeList.length; i++)
		nodeList.item(i).style.visibility = vis;
}
